...
import { type CustomizeField, type KeymapChoice, routeCustomizeKey } from "./customize-keyboard.js";
...
export const Customize: React.NamedExoticComponent<CustomizeProps> = React.memo(function Customize({
  mode,
  presets,
  defaultPresetName,
  defaultName,
  ...
  const initialCursor = Math.max(
    0,
    presets.findIndex((p) => p.name === defaultPresetName),
  );
