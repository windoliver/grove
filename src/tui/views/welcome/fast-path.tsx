...
export const FastPath: React.NamedExoticComponent<FastPathProps> = React.memo(function FastPath({
  groveName,
  sessions,
  onResume,
  onNewSession,
    ...
    >
      ...
      >
        ...
        {windowed.map((s, i) => {
          ...
          return <SessionRow key={s.id} session={s} focused={globalIdx === cursor} />;
        })}
      </box>
