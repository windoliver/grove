...
// Re-exported for consumers that historically imported it from here. The
// implementation lives in actions/fuzzy.ts so visibility.ts and this component
// can both depend on it without a circular import.
export { fuzzyMatch } from "../actions/fuzzy.js";
